...
public class AsyncSchemasClient {
  ...
  public CompletableFuture<SchemaPage> listSchemas(ListSchemasRequest request,
    ...
    return this.rawClient.listSchemas(request, requestOptions).thenApply(response -> response.body());
  }
   ...
   */
  public CompletableFuture<SchemaResponse> getSchema(String id) {
    return this.rawClient.getSchema(id).thenApply(response -> response.body());
  }

  /**
   * Retrieves a single record schema by its id. Requires the <code>schemas:r</code> scope.
   */
  public CompletableFuture<SchemaResponse> getSchema(String id, RequestOptions requestOptions) {
    return this.rawClient.getSchema(id, requestOptions).thenApply(response -> response.body());
  }

  /**
   * Retrieves a single record schema by its id. Requires the <code>schemas:r</code> scope.
   */
  public CompletableFuture<SchemaResponse> getSchema(String id, GetSchemaRequest request) {
    return this.rawClient.getSchema(id, request).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<SchemaResponse> getSchema(String id, GetSchemaRequest request,
      RequestOptions requestOptions) {
    return this.rawClient.getSchema(id, request, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<SchemaResponse> updateSchema(String id, UpdateSchemaRequest request,
      RequestOptions requestOptions) {
    return this.rawClient.updateSchema(id, request, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<Void> deleteSchema(String id, DeleteSchemaRequest request,
      RequestOptions requestOptions) {
    return this.rawClient.deleteSchema(id, request, requestOptions).thenApply(response -> response.body());
  }
   ...
   */
  public CompletableFuture<ModelDataVersionPage> getSchemaVersions(String id) {
    return this.rawClient.getSchemaVersions(id).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<ModelDataVersionPage> getSchemaVersions(String id,
      RequestOptions requestOptions) {
    return this.rawClient.getSchemaVersions(id, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<ModelDataVersionPage> getSchemaVersions(String id,
    ...
    return this.rawClient.getSchemaVersions(id, request).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<ModelDataVersionPage> getSchemaVersions(String id,
    ...
    return this.rawClient.getSchemaVersions(id, request, requestOptions).thenApply(response -> response.body());
  }
}
