...
public class RawDocumentsClient {
  ...
  public VectrosApiHttpResponse<DocumentPage> listDocuments(ListDocumentsRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DocumentPage.class), response);
        }
    ...
    public VectrosApiHttpResponse<DocumentResponse> ingestDocument(IngestDocumentRequest request,
       ...
       */
      public VectrosApiHttpResponse<DocumentResponse> getDocument(String id) {
      ...
      public VectrosApiHttpResponse<DocumentResponse> getDocument(String id,
         ...
         */
        public VectrosApiHttpResponse<DocumentResponse> updateDocument(String id,
        ...
        public VectrosApiHttpResponse<DocumentResponse> updateDocument(String id,
          ...
          public VectrosApiHttpResponse<Void> deleteDocument(String id,
             ...
             */
            public VectrosApiHttpResponse<DocumentResponse> patchDocument(String id,
             ...
             */
            public VectrosApiHttpResponse<DocumentResponse> patchDocument(String id,
                PatchDocumentRequest request, RequestOptions requestOptions) {
              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
              ...
              public VectrosApiHttpResponse<DocumentLookupPage> lookupDocuments(
                 ...
                 */
                public VectrosApiHttpResponse<DocumentLookupPage> lookupDocumentsByBody(
                ...
                public VectrosApiHttpResponse<DocumentLookupPage> lookupDocumentsByBody(
                   ...
                   */
                  public VectrosApiHttpResponse<DocumentDownloadResponse> getDocumentDownloadUrl(
                      String id) {
                  ...
                  public VectrosApiHttpResponse<DocumentDownloadResponse> getDocumentDownloadUrl(
                    ...
                    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                      ...
                      try (Response response = client.newCall(okhttpRequest).execute()) {
                        ...
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          return new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DocumentDownloadResponse.class), response);
                        }
                        try {
                          switch (response.code()) {
                            case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
                    ...
                    public VectrosApiHttpResponse<DocumentTextResponse> getDocumentText(String id,
                      ...
                      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                        ...
                        try (Response response = client.newCall(okhttpRequest).execute()) {
                          ...
                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                          if (response.isSuccessful()) {
                            return new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DocumentTextResponse.class), response);
                          }
                          try {
                            if (response.code() == 404) {
                              throw new NotFoundError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
                       ...
                       */
                      public VectrosApiHttpResponse<ModelDataVersionPage> getDocumentVersions(
                          String id) {
                      ...
                      public VectrosApiHttpResponse<ModelDataVersionPage> getDocumentVersions(
                         ...
                         */
                        public VectrosApiHttpResponse<FileUploadResponse> uploadDocument(
