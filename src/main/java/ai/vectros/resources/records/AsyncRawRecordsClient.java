...
public class AsyncRawRecordsClient {
   ...
   */
  public CompletableFuture<VectrosApiHttpResponse<BatchGetResponse>> batchGetRecords() {
   ...
   */
  public CompletableFuture<VectrosApiHttpResponse<BatchGetResponse>> batchGetRecords(
      BatchGetRequest request, RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<VectrosApiHttpResponse<BatchGetResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, BatchGetResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<VectrosApiHttpResponse<BatchLookupResponse>> batchLookupRecords() {
    ...
    public CompletableFuture<VectrosApiHttpResponse<BatchLookupResponse>> batchLookupRecords(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<VectrosApiHttpResponse<BatchLookupResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, BatchLookupResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       */
      public CompletableFuture<VectrosApiHttpResponse<BatchWriteResponse>> batchWriteRecords() {
       ...
       */
      public CompletableFuture<VectrosApiHttpResponse<BatchWriteResponse>> batchWriteRecords(
          BatchWriteRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          CompletableFuture<VectrosApiHttpResponse<BatchWriteResponse>> future = new CompletableFuture<>();
          client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
              try (ResponseBody responseBody = response.body()) {
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, BatchWriteResponse.class), response));
                  return;
                }
                try {
                  switch (response.code()) {
        ...
        public CompletableFuture<VectrosApiHttpResponse<RecordPage>> listRecords(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            CompletableFuture<VectrosApiHttpResponse<RecordPage>> future = new CompletableFuture<>();
            client.newCall(okhttpRequest).enqueue(new Callback() {
              @Override
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RecordPage.class), response));
                    return;
                  }
                  Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
                  future.completeExceptionally(new VectrosApiApiException("Error with status code " + response.code(), response.code(), errorBody, response));
           ...
           */
          public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> createRecord(
              RecordRequest body) {
           ...
           */
          public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> createRecord(
              RecordRequest body, RequestOptions requestOptions) {
           ...
           */
          public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> createRecord(
              CreateRecordRequest request, RequestOptions requestOptions) {
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
              ...
              CompletableFuture<VectrosApiHttpResponse<RecordResponse>> future = new CompletableFuture<>();
              client.newCall(okhttpRequest).enqueue(new Callback() {
                @Override
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                  try (ResponseBody responseBody = response.body()) {
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RecordResponse.class), response));
                      return;
                    }
                    try {
                      switch (response.code()) {
             ...
             */
            public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> getRecord(String id) {
            ...
            public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> getRecord(String id,
               ...
               */
              public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> updateRecord(
                  String id, UpdateRecordRequest request, RequestOptions requestOptions) {
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                 ...
                 */
                public CompletableFuture<VectrosApiHttpResponse<Void>> deleteRecord(String id) {
                ...
                public CompletableFuture<VectrosApiHttpResponse<Void>> deleteRecord(String id,
                   ...
                   */
                  public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> patchRecord(
                      String id, PatchRecordRequest request) {
                   ...
                   */
                  public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> patchRecord(
                      String id, PatchRecordRequest request, RequestOptions requestOptions) {
                    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                     ...
                     */
                    public CompletableFuture<VectrosApiHttpResponse<RecordLookupPage>> lookupRecords(
                    ...
                    public CompletableFuture<VectrosApiHttpResponse<RecordLookupPage>> lookupRecords(
                      ...
                      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                        ...
                        CompletableFuture<VectrosApiHttpResponse<RecordLookupPage>> future = new CompletableFuture<>();
                        client.newCall(okhttpRequest).enqueue(new Callback() {
                          @Override
                          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                            try (ResponseBody responseBody = response.body()) {
                              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                              if (response.isSuccessful()) {
                                future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RecordLookupPage.class), response));
                                return;
                              }
                              try {
                       ...
                       */
                      public CompletableFuture<VectrosApiHttpResponse<RecordLookupPage>> lookupRecordsByBody(
                      ...
                      public CompletableFuture<VectrosApiHttpResponse<RecordLookupPage>> lookupRecordsByBody(
                         ...
                         */
                        public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> getRecordTombstone(
                            String id) {
                         ...
                         */
                        public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> getRecordTombstone(
                            String id, GetRecordTombstoneRequest request) {
                        ...
                        public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> getRecordTombstone(
                           ...
                           */
                          public CompletableFuture<VectrosApiHttpResponse<ModelDataVersionPage>> getRecordVersions(
                              String id) {
