                  ...
                  public CompletableFuture<VectrosApiHttpResponse<RecordResponse>> patchRecord(
                    ...
                    public CompletableFuture<VectrosApiHttpResponse<RecordLookupResponse>> lookupRecords(
                      ...
                      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                        ...
                        CompletableFuture<VectrosApiHttpResponse<RecordLookupResponse>> future = new CompletableFuture<>();
                        client.newCall(okhttpRequest).enqueue(new Callback() {
                          @Override
                          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                            try (ResponseBody responseBody = response.body()) {
                              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                              if (response.isSuccessful()) {
                                future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RecordLookupResponse.class), response));
                                return;
                              }
                              try {
                       ...
                       */
                      public CompletableFuture<VectrosApiHttpResponse<RecordLookupResponse>> lookupRecordsByBody(
