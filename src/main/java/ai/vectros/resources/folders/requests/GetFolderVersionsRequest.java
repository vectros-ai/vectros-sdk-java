...
@JsonDeserialize(
    builder = GetFolderVersionsRequest.Builder.class
)
public final class GetFolderVersionsRequest {
  private final Optional<String> startFrom;

  private final Map<String, Object> additionalProperties;

  private GetFolderVersionsRequest(Optional<String> startFrom,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetFolderVersionsRequest && equalTo((GetFolderVersionsRequest) other);
  }
  ...
  private boolean equalTo(GetFolderVersionsRequest other) {
  ...
  public static final class Builder {
    ...
    public Builder from(GetFolderVersionsRequest other) {
    ...
    public GetFolderVersionsRequest build() {
      return new GetFolderVersionsRequest(startFrom, additionalProperties);
    }
