...
public class AsyncRawAuthClient {
   ...
   */
  public CompletableFuture<VectrosApiHttpResponse<JwksResponse>> getJwks() {
    return getJwks(null);
  }
  ...
  public CompletableFuture<VectrosApiHttpResponse<JwksResponse>> getJwks(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<VectrosApiHttpResponse<JwksResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, JwksResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<VectrosApiHttpResponse<ReadAccessLogPage>> getAccessLog() {
     ...
     */
    public CompletableFuture<VectrosApiHttpResponse<ReadAccessLogPage>> getAccessLog(
        GetAccessLogRequest request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<VectrosApiHttpResponse<ReadAccessLogPage>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ReadAccessLogPage.class), response));
                return;
              }
              try {
       ...
       */
      public CompletableFuture<VectrosApiHttpResponse<ScopedKeyPage>> listScopedKeys() {
      ...
      public CompletableFuture<VectrosApiHttpResponse<ScopedKeyPage>> listScopedKeys(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          CompletableFuture<VectrosApiHttpResponse<ScopedKeyPage>> future = new CompletableFuture<>();
          client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
              try (ResponseBody responseBody = response.body()) {
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ScopedKeyPage.class), response));
                  return;
                }
                try {
         ...
         */
        public CompletableFuture<VectrosApiHttpResponse<ScopedKeyResponse>> createScopedKey(
        ...
        public CompletableFuture<VectrosApiHttpResponse<ScopedKeyResponse>> createScopedKey(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            CompletableFuture<VectrosApiHttpResponse<ScopedKeyResponse>> future = new CompletableFuture<>();
            client.newCall(okhttpRequest).enqueue(new Callback() {
              @Override
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ScopedKeyResponse.class), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
           ...
           */
          public CompletableFuture<VectrosApiHttpResponse<ScopedKeyResponse>> getScopedKey(
              String keyId) {
           ...
           */
          public CompletableFuture<VectrosApiHttpResponse<ScopedKeyResponse>> getScopedKey(
              String keyId, GetScopedKeyRequest request) {
           ...
           */
          public CompletableFuture<VectrosApiHttpResponse<ScopedKeyResponse>> getScopedKey(
              String keyId, GetScopedKeyRequest request, RequestOptions requestOptions) {
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            public CompletableFuture<VectrosApiHttpResponse<Void>> revokeScopedKey(String keyId,
               ...
               */
              public CompletableFuture<VectrosApiHttpResponse<AdminLogsResponse>> getAdminLogs(
              ...
              public CompletableFuture<VectrosApiHttpResponse<AdminLogsResponse>> getAdminLogs(
                ...
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                  ...
                  CompletableFuture<VectrosApiHttpResponse<AdminLogsResponse>> future = new CompletableFuture<>();
                  client.newCall(okhttpRequest).enqueue(new Callback() {
                    @Override
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                      try (ResponseBody responseBody = response.body()) {
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AdminLogsResponse.class), response));
                          return;
                        }
                        try {
                          switch (response.code()) {
                 ...
                 */
                public CompletableFuture<VectrosApiHttpResponse<AccessProfilePage>> listAccessProfiles(
                    String contextId) {
                ...
                public CompletableFuture<VectrosApiHttpResponse<AccessProfilePage>> listAccessProfiles(
                  ...
                  public CompletableFuture<VectrosApiHttpResponse<AccessProfileResponse>> createAccessProfile(
                    ...
                    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                      ...
                      CompletableFuture<VectrosApiHttpResponse<AccessProfileResponse>> future = new CompletableFuture<>();
                      client.newCall(okhttpRequest).enqueue(new Callback() {
                        @Override
                        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                          try (ResponseBody responseBody = response.body()) {
                            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                            if (response.isSuccessful()) {
                              future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AccessProfileResponse.class), response));
                              return;
                            }
                            try {
                              switch (response.code()) {
                    ...
                    public CompletableFuture<VectrosApiHttpResponse<AppContextPage>> listAppContexts(
                      ...
                      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                        ...
                        CompletableFuture<VectrosApiHttpResponse<AppContextPage>> future = new CompletableFuture<>();
                        client.newCall(okhttpRequest).enqueue(new Callback() {
                          @Override
                          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                            try (ResponseBody responseBody = response.body()) {
                              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                              if (response.isSuccessful()) {
                                future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AppContextPage.class), response));
                                return;
                              }
                              try {
                                if (response.code() == 403) {
                      ...
                      public CompletableFuture<VectrosApiHttpResponse<AppContextResponse>> createAppContext(
                        ...
                        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                          ...
                          CompletableFuture<VectrosApiHttpResponse<AppContextResponse>> future = new CompletableFuture<>();
                          client.newCall(okhttpRequest).enqueue(new Callback() {
                            @Override
                            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                              try (ResponseBody responseBody = response.body()) {
                                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                if (response.isSuccessful()) {
                                  future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AppContextResponse.class), response));
                                  return;
                                }
                                try {
                                  switch (response.code()) {
                         ...
                         */
                        public CompletableFuture<VectrosApiHttpResponse<RolePage>> listRoles(
                            String contextId) {
                         ...
                         */
                        public CompletableFuture<VectrosApiHttpResponse<RolePage>> listRoles(
                            String contextId, ListRolesRequest request) {
                        ...
                        public CompletableFuture<VectrosApiHttpResponse<RolePage>> listRoles(
                          ...
                          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                            ...
                            CompletableFuture<VectrosApiHttpResponse<RolePage>> future = new CompletableFuture<>();
                            client.newCall(okhttpRequest).enqueue(new Callback() {
                              @Override
                              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                try (ResponseBody responseBody = response.body()) {
                                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                  if (response.isSuccessful()) {
                                    future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RolePage.class), response));
                                    return;
                                  }
                                  try {
                                    switch (response.code()) {
                          ...
                          public CompletableFuture<VectrosApiHttpResponse<RoleResponse>> createRole(
                            ...
                            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                              ...
                              CompletableFuture<VectrosApiHttpResponse<RoleResponse>> future = new CompletableFuture<>();
                              client.newCall(okhttpRequest).enqueue(new Callback() {
                                @Override
                                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                  try (ResponseBody responseBody = response.body()) {
                                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                    if (response.isSuccessful()) {
                                      future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RoleResponse.class), response));
                                      return;
                                    }
                                    try {
                                      switch (response.code()) {
                             ...
                             */
                            public CompletableFuture<VectrosApiHttpResponse<AccessProfileResponse>> getAccessProfile(
                            ...
                            public CompletableFuture<VectrosApiHttpResponse<AccessProfileResponse>> getAccessProfile(
                               ...
                               */
                              public CompletableFuture<VectrosApiHttpResponse<AccessProfileResponse>> updateAccessProfile(
                                  String contextId, String principalId,
                              ...
                              public CompletableFuture<VectrosApiHttpResponse<AccessProfileResponse>> updateAccessProfile(
                                 ...
                                 */
                                public CompletableFuture<VectrosApiHttpResponse<Void>> deleteAccessProfile(
                                    String contextId, String principalId) {
                                ...
                                public CompletableFuture<VectrosApiHttpResponse<Void>> deleteAccessProfile(
                                   ...
                                   */
                                  public CompletableFuture<VectrosApiHttpResponse<AppContextResponse>> getAppContext(
                                      String contextId) {
                                  ...
                                  public CompletableFuture<VectrosApiHttpResponse<AppContextResponse>> getAppContext(
                                     ...
                                     */
                                    public CompletableFuture<VectrosApiHttpResponse<AppContextResponse>> updateAppContext(
                                    ...
                                    public CompletableFuture<VectrosApiHttpResponse<AppContextResponse>> updateAppContext(
                                       ...
                                       */
                                      public CompletableFuture<VectrosApiHttpResponse<Void>> deleteAppContext(
                                          String contextId) {
                                      ...
                                      public CompletableFuture<VectrosApiHttpResponse<Void>> deleteAppContext(
                                         ...
                                         */
                                        public CompletableFuture<VectrosApiHttpResponse<RoleResponse>> getRole(
                                        ...
                                        public CompletableFuture<VectrosApiHttpResponse<RoleResponse>> getRole(
                                           ...
                                           */
                                          public CompletableFuture<VectrosApiHttpResponse<RoleResponse>> updateRole(
                                              String contextId, String roleId,
                                          ...
                                          public CompletableFuture<VectrosApiHttpResponse<RoleResponse>> updateRole(
                                             ...
                                             */
                                            public CompletableFuture<VectrosApiHttpResponse<Void>> deleteRole(
                                                String contextId, String roleId) {
                                            ...
                                            public CompletableFuture<VectrosApiHttpResponse<Void>> deleteRole(
                                              ...
                                              public CompletableFuture<VectrosApiHttpResponse<ModelDataVersionPage>> getAccessProfileVersions(
                                                ...
                                                public CompletableFuture<VectrosApiHttpResponse<ModelDataVersionPage>> getRoleVersions(
                                                   ...
                                                   */
                                                  public CompletableFuture<VectrosApiHttpResponse<UsageReportResponse>> getUsage(
                                                      ) {
                                                  ...
                                                  public CompletableFuture<VectrosApiHttpResponse<UsageReportResponse>> getUsage(
                                                    ...
                                                    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                                                      ...
                                                      CompletableFuture<VectrosApiHttpResponse<UsageReportResponse>> future = new CompletableFuture<>();
                                                      client.newCall(okhttpRequest).enqueue(new Callback() {
                                                        @Override
                                                        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                                          try (ResponseBody responseBody = response.body()) {
                                                            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                                                            if (response.isSuccessful()) {
                                                              future.complete(new VectrosApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UsageReportResponse.class), response));
                                                              return;
                                                            }
                                                            try {
                                                              switch (response.code()) {
