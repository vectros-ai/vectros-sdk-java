...
public class AsyncAuthClient {
  ...
  /**
   * Updates the name, description, and/or companyName of an app context. This is a partial update: any field you omit (or send as null) keeps its existing value. The <code>contextId</code> is immutable and is taken from the URL path, so any <code>contextId</code> in the request body is ignored. Requires the <code>app-contexts:u</code> scope.
   */
