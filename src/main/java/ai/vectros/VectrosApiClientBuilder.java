...
public class VectrosApiClientBuilder {
   ...
   * Sets token
   */
  public VectrosApiClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public VectrosApiClientBuilder url(String url) {
   ...
   */
  public VectrosApiClientBuilder timeout(int timeout) {
   ...
   */
  public VectrosApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public VectrosApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public VectrosApiClientBuilder logging(LogConfig logging) {
   ...
   */
  public VectrosApiClientBuilder addHeader(String name, String value) {
