...
@JsonDeserialize(
    builder = AppContextPage.Builder.class
)
public final class AppContextPage {
  private final Optional<List<AppContextResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private AppContextPage(Optional<List<AppContextResponse>> data, Optional<String> nextCursor,
   ...
   */
  @JsonProperty("data")
  public Optional<List<AppContextResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof AppContextPage && equalTo((AppContextPage) other);
  }
  ...
  private boolean equalTo(AppContextPage other) {
  ...
  public static final class Builder {
    private Optional<List<AppContextResponse>> data = Optional.empty();
    ...
    public Builder from(AppContextPage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<AppContextResponse>> data) {
      this.data = data;
      return this;
    }

    public Builder data(List<AppContextResponse> data) {
    ...
    public AppContextPage build() {
      return new AppContextPage(data, nextCursor, additionalProperties);
    }
