...
@JsonDeserialize(
    builder = FolderPage.Builder.class
)
public final class FolderPage {
  private final Optional<List<FolderResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private FolderPage(Optional<List<FolderResponse>> data, Optional<String> nextCursor,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FolderPage && equalTo((FolderPage) other);
  }
  ...
  private boolean equalTo(FolderPage other) {
  ...
  public static final class Builder {
    private Optional<List<FolderResponse>> data = Optional.empty();
    ...
    public Builder from(FolderPage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<FolderResponse>> data) {
      this.data = data;
      return this;
    }

    public Builder data(List<FolderResponse> data) {
    ...
    public FolderPage build() {
      return new FolderPage(data, nextCursor, additionalProperties);
    }
