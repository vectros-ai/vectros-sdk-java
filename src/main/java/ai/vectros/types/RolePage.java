...
@JsonDeserialize(
    builder = RolePage.Builder.class
)
public final class RolePage {
  private final Optional<List<RoleResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private RolePage(Optional<List<RoleResponse>> data, Optional<String> nextCursor,
   ...
   */
  @JsonProperty("data")
  public Optional<List<RoleResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof RolePage && equalTo((RolePage) other);
  }
  ...
  private boolean equalTo(RolePage other) {
  ...
  public static final class Builder {
    private Optional<List<RoleResponse>> data = Optional.empty();
    ...
    public Builder from(RolePage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<RoleResponse>> data) {
      this.data = data;
      return this;
    }
    ...
    public RolePage build() {
      return new RolePage(data, nextCursor, additionalProperties);
    }
