...
@JsonDeserialize(
    builder = IssuerPage.Builder.class
)
public final class IssuerPage {
  private final Optional<List<IssuerResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private IssuerPage(Optional<List<IssuerResponse>> data, Optional<String> nextCursor,
   ...
   */
  @JsonProperty("data")
  public Optional<List<IssuerResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof IssuerPage && equalTo((IssuerPage) other);
  }
  ...
  private boolean equalTo(IssuerPage other) {
  ...
  public static final class Builder {
    private Optional<List<IssuerResponse>> data = Optional.empty();
    ...
    public Builder from(IssuerPage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<IssuerResponse>> data) {
      this.data = data;
      return this;
    }

    public Builder data(List<IssuerResponse> data) {
    ...
    public IssuerPage build() {
      return new IssuerPage(data, nextCursor, additionalProperties);
    }
