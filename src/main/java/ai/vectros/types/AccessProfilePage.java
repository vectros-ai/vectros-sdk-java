...
@JsonDeserialize(
    builder = AccessProfilePage.Builder.class
)
public final class AccessProfilePage {
  private final Optional<List<AccessProfileResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private AccessProfilePage(Optional<List<AccessProfileResponse>> data, Optional<String> nextCursor,
   ...
   */
  @JsonProperty("data")
  public Optional<List<AccessProfileResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof AccessProfilePage && equalTo((AccessProfilePage) other);
  }
  ...
  private boolean equalTo(AccessProfilePage other) {
  ...
  public static final class Builder {
    private Optional<List<AccessProfileResponse>> data = Optional.empty();
    ...
    public Builder from(AccessProfilePage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<AccessProfileResponse>> data) {
      this.data = data;
      return this;
    }

    public Builder data(List<AccessProfileResponse> data) {
    ...
    public AccessProfilePage build() {
      return new AccessProfilePage(data, nextCursor, additionalProperties);
    }
