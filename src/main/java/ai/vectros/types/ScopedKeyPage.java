...
@JsonDeserialize(
    builder = ScopedKeyPage.Builder.class
)
public final class ScopedKeyPage {
  private final Optional<List<ScopedKeyResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private ScopedKeyPage(Optional<List<ScopedKeyResponse>> data, Optional<String> nextCursor,
   ...
   */
  @JsonProperty("data")
  public Optional<List<ScopedKeyResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ScopedKeyPage && equalTo((ScopedKeyPage) other);
  }
  ...
  private boolean equalTo(ScopedKeyPage other) {
  ...
  public static final class Builder {
    private Optional<List<ScopedKeyResponse>> data = Optional.empty();
    ...
    public Builder from(ScopedKeyPage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<ScopedKeyResponse>> data) {
      this.data = data;
      return this;
    }

    public Builder data(List<ScopedKeyResponse> data) {
    ...
    public ScopedKeyPage build() {
      return new ScopedKeyPage(data, nextCursor, additionalProperties);
    }
