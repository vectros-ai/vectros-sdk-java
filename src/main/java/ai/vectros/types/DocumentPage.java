...
@JsonDeserialize(
    builder = DocumentPage.Builder.class
)
public final class DocumentPage {
  ...
  private DocumentPage(Optional<List<DocumentResponse>> data, Optional<String> nextCursor,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DocumentPage && equalTo((DocumentPage) other);
  }
  ...
  private boolean equalTo(DocumentPage other) {
  ...
  public static final class Builder {
    ...
    public Builder from(DocumentPage other) {
      data(other.getData());
    ...
    public DocumentPage build() {
      return new DocumentPage(data, nextCursor, additionalProperties);
    }
