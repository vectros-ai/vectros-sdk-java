...
@JsonDeserialize(
    builder = ModelDataVersionPage.Builder.class
)
public final class ModelDataVersionPage {
  private final Optional<List<ModelDataVersionResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private ModelDataVersionPage(Optional<List<ModelDataVersionResponse>> data,
   ...
   */
  @JsonProperty("data")
  public Optional<List<ModelDataVersionResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ModelDataVersionPage && equalTo((ModelDataVersionPage) other);
  }
  ...
  private boolean equalTo(ModelDataVersionPage other) {
  ...
  public static final class Builder {
    private Optional<List<ModelDataVersionResponse>> data = Optional.empty();
    ...
    public Builder from(ModelDataVersionPage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<ModelDataVersionResponse>> data) {
      this.data = data;
      return this;
    }

    public Builder data(List<ModelDataVersionResponse> data) {
    ...
    public ModelDataVersionPage build() {
      return new ModelDataVersionPage(data, nextCursor, additionalProperties);
    }
