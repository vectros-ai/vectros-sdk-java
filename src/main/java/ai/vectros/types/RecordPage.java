...
@JsonDeserialize(
    builder = RecordPage.Builder.class
)
public final class RecordPage {
  ...
  private RecordPage(Optional<List<RecordResponse>> data, Optional<String> nextCursor,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof RecordPage && equalTo((RecordPage) other);
  }
  ...
  private boolean equalTo(RecordPage other) {
  ...
  public static final class Builder {
    ...
    public Builder from(RecordPage other) {
      data(other.getData());
    ...
    public RecordPage build() {
      return new RecordPage(data, nextCursor, additionalProperties);
    }
