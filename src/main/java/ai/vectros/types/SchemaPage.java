...
@JsonDeserialize(
    builder = SchemaPage.Builder.class
)
public final class SchemaPage {
  private final Optional<List<SchemaResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private SchemaPage(Optional<List<SchemaResponse>> data, Optional<String> nextCursor,
   ...
   */
  @JsonProperty("data")
  public Optional<List<SchemaResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SchemaPage && equalTo((SchemaPage) other);
  }
  ...
  private boolean equalTo(SchemaPage other) {
  ...
  public static final class Builder {
    private Optional<List<SchemaResponse>> data = Optional.empty();
    ...
    public Builder from(SchemaPage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<SchemaResponse>> data) {
      this.data = data;
      return this;
    }

    public Builder data(List<SchemaResponse> data) {
    ...
    public SchemaPage build() {
      return new SchemaPage(data, nextCursor, additionalProperties);
    }
