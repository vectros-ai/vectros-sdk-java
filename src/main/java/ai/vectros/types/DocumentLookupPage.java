...
@JsonDeserialize(
    builder = DocumentLookupPage.Builder.class
)
public final class DocumentLookupPage {
  private final Optional<List<DocumentResponse>> data;

  private final Optional<String> nextCursor;

  private final Map<String, Object> additionalProperties;

  private DocumentLookupPage(Optional<List<DocumentResponse>> data, Optional<String> nextCursor,
   ...
   */
  @JsonProperty("data")
  public Optional<List<DocumentResponse>> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof DocumentLookupPage && equalTo((DocumentLookupPage) other);
  }
  ...
  private boolean equalTo(DocumentLookupPage other) {
  ...
  public static final class Builder {
    private Optional<List<DocumentResponse>> data = Optional.empty();
    ...
    public Builder from(DocumentLookupPage other) {
      data(other.getData());
    ...
    public Builder data(Optional<List<DocumentResponse>> data) {
      this.data = data;
      return this;
    }
    ...
    public DocumentLookupPage build() {
      return new DocumentLookupPage(data, nextCursor, additionalProperties);
    }
