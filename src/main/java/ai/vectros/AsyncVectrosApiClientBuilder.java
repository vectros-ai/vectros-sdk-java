...
import ai.vectros.core.Environment;
import ai.vectros.core.LogConfig;
...
public class AsyncVectrosApiClientBuilder {
   ...
   * Sets token
   */
  public AsyncVectrosApiClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public AsyncVectrosApiClientBuilder url(String url) {
   ...
   */
  public AsyncVectrosApiClientBuilder timeout(int timeout) {
   ...
   */
  public AsyncVectrosApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncVectrosApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncVectrosApiClientBuilder logging(LogConfig logging) {
   ...
   */
  public AsyncVectrosApiClientBuilder addHeader(String name, String value) {
