...
public class VectrosApiApiException extends VectrosApiException {
  ...
  public VectrosApiApiException(String message, int statusCode, Object body, Response rawResponse) {
    super(message);
    this.statusCode = statusCode;
    this.body = body;
    this.headers = new HashMap<>();
  ...
  public String toString() {
    return "VectrosApiApiException{" + "message: " + getMessage() + ", statusCode: " + statusCode + ", body: " + ObjectMappers.stringify(body) + "}";
  }
}
